  ...
  <div className="min-h-screen flex flex-wrap">
    ...
    <div className="basis-[100%] lg:basis-[60%]">
      <div className="lg:px-16 md:px-14 sm:px-10 px-4 pt-20">
        <ul className="list-disc space-y-4 text-justify text-white lg:text-xs md:text-sm sm:text-sm ">
          <li>
            Our vision e at the forefront of technological advancement,
            empowering industries to thrive in the digital age. We are
            committed to creating a future where technology serves as a catalyst
          ...
          <li>
            ...
            applications and systems that not only meet the current needs of our
            clients but also anticipate and adapt to future challenges. We are
            dedicated to fostering a culture of continuous learning and
            improvement, ensuring that our team remains at the pinnacle of
      ...
      <div className="mt-12 lg:pl-8 flex flex-col sm:flex-row gap-8 justify-center max-w-6xl 3xl:max-w-7xl mx-auto">
          <div className="flex flex-col text-center items-center">
            <div className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl 4k:text-8xl font-bold text-white">100%</div>
            <div className="text-lg sm:text-xl lg:text-2xl 2xl:text-3xl text-white">
              Client Satisfaction Rate
            </div>
          </div>
          <div className="flex flex-col text-center items-center">
            <div className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl 4k:text-8xl font-bold text-white">20+</div>
            <div className="text-lg sm:text-xl lg:text-2xl 2xl:text-3xl text-white">
              Industries Transformed
            </div>
          </div>
          <div className="flex flex-col text-center items-center">
            <div className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl 4k:text-8xl font-bold text-white">30+</div>
            <div className="text-lg sm:text-xl lg:text-2xl 2xl:text-3xl text-white">
